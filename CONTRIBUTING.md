Contributing to XORN Core
============================

The XORN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XORN Core project, and is not to be
confused with overall XORN Network Protocol consensus changes.

Whether a pull request is merged into XORN Core rests with the project merge
...
Patches that change XORN consensus rules are considerably more involved than
...
Where a patch set proposes to change the XORN consensus, it must have been
...
The project leader is the release manager for each XORN Core release.
