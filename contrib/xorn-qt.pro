...
RESOURCES += src/qt/xorn.qrc src/qt/xorn_locale.qrc

TRANSLATIONS += src/qt/locale/xorn_bg.ts \
                src/qt/locale/xorn_de.ts \
                src/qt/locale/xorn_en.ts \
                src/qt/locale/xorn_es.ts \
                src/qt/locale/xorn_fi.ts \
                src/qt/locale/xorn_fr.ts \
                src/qt/locale/xorn_it.ts \
                src/qt/locale/xorn_ja.ts \
                src/qt/locale/xorn_pl.ts \
                src/qt/locale/xorn_pt.ts \
                src/qt/locale/xorn_ru.ts \
                src/qt/locale/xorn_sk.ts \
                src/qt/locale/xorn_sv.ts \
                src/qt/locale/xorn_vi.ts \
                src/qt/locale/xorn_zh_CN.ts \
                src/qt/locale/xorn_zh_TW.ts
