...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XORN features */
        {"xorn", "masternode", &masternode, true, true, false},
        {"xorn", "listmasternodes", &listmasternodes, true, true, false},
        {"xorn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xorn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xorn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xorn", "masternodedebug", &masternodedebug, true, true, false},
        {"xorn", "startmasternode", &startmasternode, true, true, false},
        {"xorn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xorn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xorn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xorn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xorn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xorn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xorn", "mnbudget", &mnbudget, true, true, false},
        {"xorn", "preparebudget", &preparebudget, true, true, false},
        {"xorn", "submitbudget", &submitbudget, true, true, false},
        {"xorn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xorn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xorn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xorn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xorn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xorn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xorn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xorn", "checkbudgets", &checkbudgets, true, true, false},
        {"xorn", "mnsync", &mnsync, true, true, false},
        {"xorn", "spork", &spork, true, true, false},
        {"xorn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"xorn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xornd, or the -server option to xorn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xorn-cli " + methodname + " " + args + "\n";
}
