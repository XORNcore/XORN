                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received XORN from zXORN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXORN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXORN));
