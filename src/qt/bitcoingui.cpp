                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XORN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XORN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xorn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXORN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XORN Core"), this);
    aboutAction->setStatusTip(tr("Show information about XORN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XORN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XORN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XORN addresses"));
    ...
    openAction->setStatusTip(tr("Open a XORN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XORN Core help message to get a list with possible XORN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XORN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XORN network", "", count));
}
...
{
    QString strTitle = tr("XORN Core"); // default title
