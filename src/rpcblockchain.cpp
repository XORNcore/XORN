...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.emplace_back(Pair("zXORNsupply", zxornObj));
...
Value getblock(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zXORNsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zXORN denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zXORN denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zXORN denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zXORN denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zXORN denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zXORN denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zXORN denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zXORN denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zXORN denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
