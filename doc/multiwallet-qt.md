...
In order to support loading of multiple wallets in xorn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xorn.cpp.
...
Changes to xorn.cpp
----------------------
xorn.cpp is the entry point into xorn-qt, and as such, will require some minor modifications to provide hooks for
